...
type StringsType = {
  ...
  'cornerLabels': string;
  'cornerLabelsStringProperty': LinkableProperty<string>;
  'labels': string;
  'labelsStringProperty': LinkableProperty<string>;
  'corners': string;
  'cornersStringProperty': LinkableProperty<string>;
  'diagonals': string;
  'diagonalsStringProperty': LinkableProperty<string>;
  'cornerGuides': string;
  'cornerGuidesStringProperty': LinkableProperty<string>;
  'grid': string;
  'gridStringProperty': LinkableProperty<string>;
  'diagonalGuides': string;
  'diagonalGuidesStringProperty': LinkableProperty<string>;
  'vertexA': string;
  ...
  'a11y': {
    ...
    'voicing': {
      ...
      'maintainingAParallelogramResponsePatternStringProperty': LinkableProperty<string>;
      'allRightAnglesAsShapeChangesPattern': string;
      'allRightAnglesAsShapeChangesPatternStringProperty': LinkableProperty<string>;
      'oppositeCornersChangeEquallyAsSidesChangePattern': string;
      'oppositeCornersChangeEquallyAsSidesChangePatternStringProperty': LinkableProperty<string>;
